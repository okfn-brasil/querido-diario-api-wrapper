...
class GazetteItem(BaseModel):
    ...
    excerpts: conlist(StrictStr) = Field(...)
    edition: Optional[StrictStr] = None
    is_extra_edition: Optional[StrictBool] = None
    txt_url: Optional[StrictStr] = None
    __properties = ["territory_id", "date", "scraped_at", "url", "territory_name", "state_code", "excerpts", "edition", "is_extra_edition", "txt_url"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GazetteItem:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GazetteItem:
        """Create an instance of GazetteItem from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GazetteItem.parse_obj(obj)

        _obj = GazetteItem.parse_obj({
