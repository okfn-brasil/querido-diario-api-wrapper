...
class ThemesSearchResponse(BaseModel):
    ...
    """
    themes: conlist(StrictStr) = Field(...)
    __properties = ["themes"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ThemesSearchResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ThemesSearchResponse:
        """Create an instance of ThemesSearchResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ThemesSearchResponse.parse_obj(obj)

        _obj = ThemesSearchResponse.parse_obj({
