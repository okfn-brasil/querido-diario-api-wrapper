...
class SubthemesSearchResponse(BaseModel):
    """
    SubthemesSearchResponse
    """
    subthemes: conlist(StrictStr) = Field(...)
    __properties = ["subthemes"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SubthemesSearchResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SubthemesSearchResponse:
        """Create an instance of SubthemesSearchResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SubthemesSearchResponse.parse_obj(obj)

        _obj = SubthemesSearchResponse.parse_obj({
