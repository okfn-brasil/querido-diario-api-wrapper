...
class CreatedSuggestionResponse(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CreatedSuggestionResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CreatedSuggestionResponse:
        """Create an instance of CreatedSuggestionResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CreatedSuggestionResponse.parse_obj(obj)

        _obj = CreatedSuggestionResponse.parse_obj({
