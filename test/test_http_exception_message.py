...
class TestHTTPExceptionMessage(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> HTTPExceptionMessage:
        """Test HTTPExceptionMessage
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `HTTPExceptionMessage`
        """
        model = HTTPExceptionMessage()  # noqa: E501
        if include_optional:
            return HTTPExceptionMessage(
                detail = ''
            )
        else:
            return HTTPExceptionMessage(
    ...
    def testHTTPExceptionMessage(self):
        """Test HTTPExceptionMessage"""
