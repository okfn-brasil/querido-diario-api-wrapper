...
class TestThemedExcerptItem(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ThemedExcerptItem:
        """Test ThemedExcerptItem
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ThemedExcerptItem`
        """
        model = ThemedExcerptItem()  # noqa: E501
        if include_optional:
    ...
    def testThemedExcerptItem(self):
        """Test ThemedExcerptItem"""
